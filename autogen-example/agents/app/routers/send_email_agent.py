...
This FastAPI-based microservice takes in the email campaigns and prints the JSON to the terminal.
This should be extended to actually send the email as desired.
